...
{
    global $connection;
    $statement = $connection->prepare("SELECT assignments.assignment_id, assignments.title, submition.submit_status
    ...
    INNER JOIN submition.assignment_id = assignments.assignment_id
