...
<ul class="navbar-nav  bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item <?= $item['teach'][0] ?>">
        <a class="nav-link collapsed " href="/teach" data-toggle="collapse" data-target="#listTeach"
            aria-expanded="true" aria-controls="listTeach">
        ...
        <div id="listTeach" class="collapse " aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item"
                    href="/teach?classroom_id=<?= $class['classroom_id'] ?>"><?= $class['classroom_name'] ?> </a>
                <?php } ?>
            </div>
        </div>
    </li>
    <li class="nav-item <?= $item['enrollment'][0] ?>">
        <a class="nav-link  <?= $item['enrollment'][0] ?>" href="/enrollment" data-toggle="collapse"
            data-target="#listenroll" aria-expanded="true" aria-controls="listenroll">
    ...
    <div>
        <ul class="na-item">
            <a class="nav-link " href="/#" data-toggle="collapse" data-target="#profile" aria-expanded="true"
                ...
                <img src="../../assets/images/avatar/01.jpg" class='rounded-circle' style='width: 60px'>
            </a>
            <div id="profile" class="collapse bg-success" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
