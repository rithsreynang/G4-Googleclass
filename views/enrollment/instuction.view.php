...
<div class="mt-2" style="margin-left: 5%; display:flex; justify-content:space-between;">
    ...
    <div class="card shadow-sm" style="width: 25%; color: black;">
        ...
        <div class="card-body" style="height: 120px; margin-top: -20px">
            ...
            if (isset($file_name)) {
            ?>
            <div class="border rounded rounded d-flex align-items-center" style="width: 212px;">
            ...
            <div>
                <button data-bs-toggle="collapse" href="#turnInAssignment" class="bg-primary mt-3" role="button"
                    ...
                    style=" width: 212px;border: none; border-radius:5px; padding:7px; margin-top:15px">
                    ...
                    <div class="col">
                        <div class="collapse multi-collapse" id="turnInAssignment">
                            <div class="card col-xl-12 d-flex flex-column justify-content-center align-items-center"
                                ...
                                <div class=" p-3 col-xl-4 " style="width:30%; height:33vh; border-radius:10px;">
                            ...
                            <div class="card col-xl-12 d-flex flex-column justify-content-center align-items-center"
                                ...
                                <div class=" p-3 col-xl-4 " style="width:30%; height:33vh; border-radius:10px;">
                                    <form action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <p class="mt-4" style="font-size: 14px;">Unsubmit to add or change attachments.
            ...
            ?>
            <div>
                <div class=" border rounded d-flex align-items-center" style="width: 212px;">
                    <img src="../../../assets/files/drive.png" style="width: 55px">
                ...
                <button data-bs-toggle="collapse" href="#updateSubmit" class="bg-primary mt-3" role="button"
                    ...
                    style=" width: 212px;border: none; border-radius:5px; padding:7px; margin-top:1px">
                    <span class="text-white">Unsubmit </span>
                </button>
                <div class="row" style="width: 600px; ">
                    <div class="col">
            ...
            <div>
                ...
                <button data-bs-toggle="collapse" href="#makedone" class="bg-primary mt-3" role="button"
                    ...
                    style=" width: 222px;border: none; border-radius:5px; padding:7px; margin-top:15px">
