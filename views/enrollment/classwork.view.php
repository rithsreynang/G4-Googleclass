...
<div class="d-flex flex-row ml-3 border-secondary" style="margin-top: -10px;">
    <div>
        ...
        <a href="../../controllers/enrollment/people.controller.php?classroom_id=<?= $id ?>"
...
<div class="mt-4" style="margin-left: 15%;">
    ...
    <div class="dropdown">
        <button class="btn btn-primary dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown"
            aria-expanded="false">
            <i class="fa fa-plus" style=" color: white; font-size:20px; "><span class="p-2">View all
                    Assignment</span></i>
        </button>
        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
            <li><a class="dropdown-item"
                    href="../../controllers/enrollment/detail.instruction.controller.php?classroom_id=<?= $id ?>">Assignment</a>
            </li>
        </ul>
    </div>
