...
<div class="">
    <div class="d-flex flex-row ml-3 border-secondary" style="margin-top: -10px;">
        <div class='nav-item'>
            ...
            <a href="../../controllers/enrollment/people/people.controller.php?classroom_id=<?= $id ?>" class="text-dark text-decoration-none border-0 btn btn-light ">People</a>
        </div>
    ...
    <div class="mt-4">
        <div class="d-flex flex-column" style="margin-left: 140px">
            ...
            ?>
                    <div class="card rounded mt-2 col-10 p-0">
                            ...
                            <a href="" style="text-decoration:none col-8">
                                <div class="d-flex flex-row justify-content-between align-items-center">
                                    <div class="d-flex  align-items-center col-12">
                                        ...
                                        <p class="ml-2 text-dark"> New material :
                                            <?= $material['title'] ?></p>
                                    </div>
                                    <div class="">
                                        <p class="text-center" style="width: 200px;">
