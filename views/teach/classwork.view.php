...
$index = 0;
?>
<div class="d-flex  border-secondary border-top" style='margin-top: 11px'>
    <div class='p-2 nav-item d-flex align-items-center justify-content-center' style="width: 100%; gap: 10px; ">
...
<div class="mt-4 pr-5 pl-5">
    <div class="dropdown d-flex justify-content-start" style="margin-left: 85px;">
        <button class="btn alert-primary dropdown-toggle" type="button" id="dropdownMenuButton1"
            data-bs-toggle="dropdown" aria-expanded="false"><b> <i class="fa fa-plus"><span
                        class="p-2">Create</span></i></b>
        </button>
        <ul class="dropdown-menu shadow-sm" aria-labelledby="dropdownMenuButton1">
            <li><a class="dropdown-item"
                    href="../../../controllers/teach/assignment/create.assignment/assign.get.id.controller.php?user_id=<?= $user_id ?>">Assignment</a>
            </li>
            <li><a class="dropdown-item"
                    href="../../controllers/teach/material/create.material/create.material.get.id.controller.php?classroom_id=<?= $id ?>">Material</a>
            </li>
        </ul>
    </div>
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuassignment">
                            <li>
                                <a class="dropdown-item"
                                    href="../../../controllers/teach/assignment/update.assignment/update.assignment.controller.php?classroom_id=<?= $id ?>&assignment_id=<?= $assignment['assignment_id'] ?>">Edit</a>
                            </li>
                            <li>
                                <a class="dropdown-item"
                                    href="../../controllers/teach/assignment/delete.assignment/delete.assignment.controller.php?classroom_id=<?= $id ?>&assignment_id=<?= $assignment['assignment_id'] ?>">Delete</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="card p-0 rounded border-0 mt-3 col-12">
                ...
                <div class="collapse border rounded-bottom" id="collapse<?= $index ?>">
                    <div class="col card-body">
                        ...
                        <a href="../../controllers/teach/material/view-materials/material.instruction.controller.php?material_id=<?= $material['material_id'] ?>"
