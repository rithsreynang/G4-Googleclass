    ...
    <div class="dropdown">
        ...
        <ul class="dropdown-menu shadow-sm" aria-labelledby="dropdownMenuButton1">
            <li><a class="dropdown-item"
                    href="../../../controllers/teach/assignment/create.assignment.controller.php?classroom_id=<?= $id ?>&user_id=<?= $user_id ?>">Assignment</a>
            </li>
            <li><a class="dropdown-item"
                    href="../../controllers/teach/material/create.material.controller.php?classroom_id=<?= $id ?>">Material</a>
            </li>
        </ul>
    </div>
            ...
            <div class="d-flex align-items-center border card-header p-0 justify-content-between col-12">
                ...
                <div style="margin-right: 20px;">
                    <div class="dropdown" style="color: blue">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuassignment">
                            <li><a class="dropdown-item"
                                    href="../../controllers/teach/material/upload.material.controller.php?classroom_id=<?= $id ?>&material_id=<?= $material['material_id'] ?>">Edit</a>
                            </li>
