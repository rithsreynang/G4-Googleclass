...
<div class="d-flex flex-row ml-3 border-secondary">
    <div class='nav-item   d-flex align-items-center justify-content-center'
        style="width: 100%; gap: 10px; margin-top: -31px">
...
<div class="mt-4 pr-5 pl-5">
    <div class="dropdown d-flex justify-content-start">
        <button class="btn btn-light border dropdown-toggle" type="button" id="dropdownMenuButton1"
            data-bs-toggle="dropdown" aria-expanded="false"> <i class="fa fa-plus"><span class="p-2">Create</span></i>
        </button>
    ...
    <div class="d-flex flex-column align-items-center ">
        ...
        if (count($allAssignments) > 0 or count($allMaterials) > 0) {
            echo "<h4 class='mt-5'>Assignments</h4> <hr class='dropdown-divider border-secondary' style='width: 680px;'>    ";
            foreach ($allAssignments as $assignment) {
        ?>
        <div class="card p-0 rounded-1 mt-3 col-8">
        ...
        <div class="d-flex flex-column align-items-center ">
            ...
            ?>
            <h4 class="mt-5 d-flex">Materials</h4>
