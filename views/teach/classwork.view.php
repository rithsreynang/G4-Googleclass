    ...
    <div class="dropdown">
        ...
        <ul class="dropdown-menu shadow-sm" aria-labelledby="dropdownMenuButton1">
            <li><a class="dropdown-item"
                    href="../../../controllers/teach/assignment/assign.get.id.controller.php?user_id=<?= $user_id ?>">Assignment</a>
            </li>
            <li><a class="dropdown-item"
    ...
    <div class="d-flex flex-column ">
        ...
        <div class="card p-0 rounded-1 mt-3 col-10">
                ...
                <div style="margin-right: 20px;">
                    <div class="dropdown" style="color: blue">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuassignment">
                            ...
                            <li>
                                <a class="dropdown-item"
                                    href="../../controllers/teach/assignment/delete.assignment.controller.php?classroom_id=<?= $id ?>&assignment_id=<?= $assignment['assignment_id'] ?>">Delete</a>
                            </li>
                            <li>
            ...
            <div class="collapse border rounded-bottom p-3 card-body " id="collapse<?= $assignment['assignment_id'] ?>">
                ...
                <a href="../../controllers/teach/assignment.detail/instructions.controller.php?assignment_id=<?= $assignment['assignment_id'] ?>"
