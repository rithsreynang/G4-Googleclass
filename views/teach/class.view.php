    ...
    <div>
        <div class=" d-flex flex-column justify-content-between p-3">
            <div class="card shadow-sm p-2 d-flex flex-row justify-content-between">
                ...
                <div class="border d-flex flex-column justify-content-center align-items-center shadow-sm rounded p-3 ml-2" style="width: 23%">
                    <img src="../../assets/images/profile/<?= $class['profile'] ?>" alt="" style="width: 60px" class="rounded-circle">
                    <p><?= $class['username'] ?></p>
                    <a href="https://mail.google.com/mail/u/1/?view=cm&fs=1&to=<?= $class['email'] ?>&tf=1" target="_blank">
                        <?= $class['email'] ?>
                    </a>
                    <p>Owner class</p>
                </div>
