...
?>
<div class="mt-4">
    <div class="d-flex flex-row mb-3" style="margin-top: -48px">
        <div class=' pt-2 nav-item d-flex align-items-center justify-content-center  border-top border-dark'
            style="width: 100%; gap: 10px; margin-top: 35px; ">
    ...
    <div class="d-flex">
        <div class="d-flex flex-column col-3">
            <div class="bg-light card p-2 rounded mt-3">
            ...
            <div class="card p-2 mt-3 d-flex flex-row align-items-center bg-light">
                <div class="d-flex flex-column" data-toggle="tooltip" data-placement="top" title="Copy class code">
                    <h6>Class code : </h6>
                    <div class='d-flex'>
                        <p id="textBoard" class=""><b><?= $class_code ?></b></p>
        ...
        <div class="col-9 mt-3">
            <div class="d-flex flex-column">
                ...
                ?>
                <div class=" mb-3">
                    <div class="d-flex align-items-center bg-light card p-0  justify-content-between"
                        data-toggle="tooltip" data-placement="top" title="Assignment : <?= $assignment['title'] ?>">
                        <div class=" d-flex flex-row justify-content-between col-12">
                            <div class="d-flex align-items-center">
                                ...
                                <a href="../../controllers/teach/assignment/view.assignment/instruction.view.controller.php?assignment_id=<?= $assignment['assignment_id'] ?>"
                                    class="ml-2 text-dark text-decoration-none"> Assignment :
                                    <?= $assignment['title'] ?></a>
                            </div>
                ...
                <div class="card p-0 rounded border-0 mb-2 ">
                    <div class="d-flex align-items-center border card bg-light p-0 justify-content-between col-12"
                        data-toggle="tooltip" data-placement="top" title="Material : <?=  $material['title']?>">
                        <div class=" d-flex flex-row justify-content-between col-12">
                            <div class="d-flex align-items-center">
                                <div class="rounded-circle d-flex"
                                    style="background-color: #289AE3 ; padding: 7px; color: white">
                                ...
                                <a href="../../controllers/teach/material/view-materials/material.instruction.controller.php?material_id=<?= $material['material_id'] ?>?material_id=<?= $material['material_id'] ?>"
                                    class="ml-2 text-dark text-decoration-none"> Material :
                                    <?= $material['title'] ?></a>
                            </div>
                            <div class="d-flex align-items-center justify-content-between">
