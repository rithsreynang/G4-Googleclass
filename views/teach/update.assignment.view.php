...
<body>
    ...
    <div class="m-3">
        <form action="../../controllers/teach/confirm.update.assignment.controller.php?classroom_id=<?= $classroom_id ?>&assignment_id=<?= $assignment_id ?>" class="d-flex justify-content-center align-items-center" method="post" enctype="multipart/form-data">
            <div class="col-9">
                <div class="form-group p-3 bg-light rounded mt-3">
                    <label for="title">Title:</label>
                    <input type="text" class="form-control" value="<?= $assignment['title'] ?>" id="title" placeholder="Title of Assignment" name="title">
                </div>
                ...
                <div class="form-group​ p-3 bg-light rounded">
                    ...
                    <input type="file" class="form-control-file border p-2 rounded" value="<?= $assignment['file'] ?>" id="files" name="file">
                </div>
            </div>
