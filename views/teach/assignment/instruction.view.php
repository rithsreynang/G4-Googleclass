...
?>
<div class='d-flex align-items-center border-top border-secondary justify-content-center' style="margin-top: 12px">
    <div class=" col-10">
        <div class="mt-3">
            <a href="#" class="text-white text-decoration-none btn btn-primary link">
            ...
            <a href="controllers/teach/assignment/view.assignment/student.work.controller.php?classroom_id=<?= $classroom_id ?>&assignment_id=<?= $assignment_id ?>"
                class="text-white text-decoration-none btn btn-primary link">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                    ...
                    <div class=" d-flex flex-row justify-content-between col-11" data-bs-toggle="collapse"
                        ...
                        <div class="d-flex align-items-center">
                            <div class="rounded-circle d-flex"
                                style="background-color: #289AE3 ; padding: 10px; color: white">
