...
<body>
  ...
  <div class="m-3">
    <form action="../../../controllers/teach/assignment/drop.assignment.controller.php?classroom_id=<?= $id ?>&user_id=<?= $user_id ?>" id="createAssignment" class="d-flex justify-content-center align-items-center" method="post" enctype="multipart/form-data">
      <div class="col-8 bg-white">
        <div class="d-flex bg-light  rounded justify-center-between">
        ...
        <div class="form-group​  mt-2 p-3 bg-light rounded">
