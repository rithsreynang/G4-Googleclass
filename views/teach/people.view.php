...
<div class="">
    <div class=" d-flex flex-row ml-3  border-secondary">
        <div class='nav-item d-flex align-items-center justify-content-center' style="width: 100%; gap: 10px; margin-top: -30px">
    ...
    <div class="container col-8 mt-5">
        ...
        <div class="border-top">
            ...
            ?>
                <div class="d-flex border bg-light mt-3 p-2 rounded justify-content-between">
                    <div class="d-flex align-items-center justify-content-center">
                ...
                <div class="d-flex border bg-light mt-3 p-2 rounded justify-content-between">
                    <div class="d-flex justify-content-center align-items-center">
                        <div>
                            ...
                            ?>
                                <img src="assets/images/profile/<?= $student['profile'] ?>" alt="avatar" style="border-radius: 50%" ; height="50px">
                            <?php
                            } else {
                            ?>
