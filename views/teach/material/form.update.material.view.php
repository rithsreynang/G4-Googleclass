...
<body>
    <div class="mt-2 d-flex flex-row border-bottom border-secondary" style="font-size:20px; ">
        <a onclick="history.back()" class="ml-5 text-dark text-decoration-none border-0 "
            style=" margin-right: 25px;"><i class="fa fa-close"></i></a>
        <i class="fa fa-file-text-o" style=" margin-right: 25px; margin-top: 8px;"></i>
        <p>Update Material</p>
    </div>
    <div class="m-3">
        <form
            action="../../../controllers/teach/material/update.material/confirm.update.material.controller.php?classroom_id=<?= $classroom_id ?>&material_id=<?= $material_id ?>"
            ...
            <div class="col-9">
                <div class="form-group p-3 bg-light rounded mt-3">
                    ...
                    <input type="text" class="form-control" value="<?= $material['title'] ?>" id="title"
                        placeholder="Title of material" name="title">
                </div>
                <div class="form-group p-3 bg-light rounded">
                    <label for="description">Description:</label>
                    <textarea class="form-control" id="description" name="description" rows="5"
                        placeholder="Instruction (Option)"><?= $material['description']?></textarea>
                </div>

                <div class="d-flex justify-content-end mt-3">
                    <a onclick="history.back()"
                        class="ml-5 btn btn-light border border-primary text-dark text-decoration-none border-0 "
