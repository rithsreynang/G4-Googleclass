						...
						<div class="col-sm-10 col-xl-8 m-auto">
							...
							<form>
								...
								<div class="mb-4">
									...
									<div class="input-group input-group-lg border border-primary rounded-2 ">
										<span class="input-group-text bg-light rounded-start border-0  text-secondary px-3 rounded-start "><i class="bi bi-envelope-fill"></i></span>
										<input type="email" class="form-control border-0  bg-light rounded-end ps-1 rounded-end " placeholder="E-mail" id="exampleInputEmail1">
									</div>
								</div>
								<!-- Password -->
								<div class="mb-4">
									...
									<div class="input-group input-group-lg border border-primary rounded-2 ">
										<span class="input-group-text bg-light rounded-start border-0 text-secondary px-3 rounded-start"><i class="fas fa-lock"></i></span>
