            ...
            <ul style="list-style-type: none" class="d-flex ">
                ...
                <li>
                    ...
                    <div class="modal fade" id="addClassModal" tabindex="-1" role="dialog"
                        aria-laddClassby="exampleModalLabel" aria-hidden="true">
                        <form action="../../controllers/classroom/create.classroom/create.classroom.controller.php"
                            method="post">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <div class="modal-body">
                                        <input type="text" class="form-control mt-3" name="className"
                                            placeholder="Class name" require>
                                        <input type="text" class="form-control mt-3" name="section"
                                            placeholder="Section">
                                        <input type="text" class="form-control mt-3" name="subject"
                                            placeholder="Subject">
                ...
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item dropdown">
                        <a class="nav-link rounded-circle" href="#" role="button" data-toggle="dropdown"
                            ...
                            style="margin-top: -185px; margin-left:195px; height:30px; width: 30px">
                        ...
                        <div class="dropdown-menu dropdown-menu-left bg-light" aria-labelledby="navbarDropdownProfile"
                            style='margin-top: -185px; margin-left: 50px'>
                            ...
                            <div class="dropdown-menu dropdown-menu-left" aria-labelledby="navbarDropdownProfile">
                                <div class="card col-xl-12 d-flex flex-column justify-content-center align-items-center"
                                    ...
                                    <div class="bg-white p-3 col-xl-4 rounded">
                                        <form
                                            action="../../controllers/classroom/update.classroom/modify.update.controller.php?classroom_id=<?= $class['classroom_id'] ?>"
                                            method="post">
                            ...
                            <a href="../controllers/classroom/delete.classroom/delete.class.controller.php?classroom_id=<?= $class['classroom_id'] ?>"
                                class='dropdown-item nav-link'>Delete</a>
                            <a href="../../controllers/classroom/change.banner/change.banner.controller.php?classroom_id=<?= $class['classroom_id'] ?>"
        ...
        <div class="card bg-opacity-30 m-3 shadow-sm rounded" style="width:245px;">
            ...
            <div class="navbar  navbar-expand-lg navbar-light p-1 h-1" style="height: 20px;">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item dropdown">
                        <a class="nav-link rounded-circle" href="#" role="button" data-toggle="dropdown"
                            aria-haspopup="true" aria-expanded="false"
                            style="margin-top: -190px; margin-left:195px; height:30px; width: 30px">
                            <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor"
                                class="bi bi-three-dots-vertical d-flex justify-content-center mr-5"
                                viewBox="0 0 16 16">
                                <path
            ...
            <div class="card-body p-2" style="margin-top: -15px;">
                <div class="nav-list d-flex "><b>
                        <a href="../../controllers/enrollment/steam/enrollment.controller.php?classroom_id=<?= $class['classroom_id'] ?>"
                            style="text-decoration: none;">
                            <p class="card-title"><?= $class['classroom_name'] ?></p>
                        </a></b>
                </div>
