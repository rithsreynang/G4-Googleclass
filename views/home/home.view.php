<div class="col-xml-12">
    ...
    <nav class="navbar" style="border-width: 3px; border-color: gray">
        ...
        <!-- Modal -->
        <div class="modal fade" id="addClassModal" tabindex="-1" role="dialog" aria-laddClassby="exampleModalLabel"
            aria-hidden="true">
                            ...
                            <div class="card col-xl-12 d-flex flex-column justify-content-center align-items-center"
                                ...
                                <div class="bg-white p-3 col-xl-4 rounded">
                                    <form
                                        ...
                                        <input type="text" value="<?= $class['section'] ?>" class="form-control mt-3"
                                            name="section" placeholder="Section">
                                        <input type="text" value="<?= $class['subject'] ?>" class="form-control mt-3"
