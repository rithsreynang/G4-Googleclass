...
$viewAnAssignments = getAllAssignment($id);
var_dump($viewAnAssignments);
...
<div class="border-bottom">
    <div class="" style="margin-bottom:10px;">
        ...
        <a href="../../controllers/todo/missing/missing.controller.php" class="text-dark text-decoration-none btn btn-light mt-2 link">Missing</a>
...
<div class="mt-4" style="margin-left: 5%;">
    <div class="d-flex flex-column ">
        <?php
            foreach ($viewAnAssignments as $assignment) {
        ?>
