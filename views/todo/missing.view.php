...
$assignmentsMissing = allAssignmentForEnrollStudent($user_id);
...
<div class="" style="margin-left: 5%;">
    <h4 class="mt-4">Missing Assignments</h4>
    <hr class="dropdown-divider border-primary" style="width: 820px;">
    <?php
    date_default_timezone_set("Asia/Phnom_Penh");
    $currentDate = date('Y-m-d H:i:s');
    foreach ($assignmentsMissing as $assignment) :
