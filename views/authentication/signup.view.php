        ...
        <div class="col-12 col-lg-6 d-md-flex align-items-center justify-content-center bg-success bg-opacity-10 vh-lg-100">
          <div class="p-3 p-lg-5">
            ...
            <div class="text-center">
              <h2 class="fw-bold">Welcome to PNC-classroom</h2>
          ...
          <div class="row my-5">
            <div class="col-sm-10 col-xl-8 m-auto">
              ...
              <form>
				...
				<div class="mb-4">
                  ...
                  <div class="input-group input-group-lg">
                    ...
                    <input type="username" class="form-control border-0 bg-light rounded-end ps-1" placeholder="username" id="exampleInputUsername">
                  </div>
                </div>
                <!-- Email -->
                <div class="mb-4">
                ...
                <div class="align-items-center mt-0">
                  <div class="d-grid">
                    <button class="btn btn-lg btn-success mb-0" type="button">Sign Up</button>
                  </div>
                </div>
              </form>
              <!-- Form END -->
              ...
              <div class="mt-4 text-center">
                <span> Have an account? <a href="sign-in.html">Login here</a></span>
              </div>
            </div>
          </div> <!-- Row END -->
        </div>
