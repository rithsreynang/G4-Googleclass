		...
		<div class="row align-items-center g-5">
			...
			<div class="col-lg-5 col-xl-6 position-relative z-index-1 text-center text-lg-start mb-5 mb-sm-0">
				...
				<h1 class="mb-0 display-8">Follow up your learning at E-
					<span class="position-relative">Classroom
						...
						<span class="position-absolute top-50 start-50 translate-middle z-index-n1">
							<svg width="350px" height="62.1px" enable-background="new 0 0 366 62.1" viewBox="0 0 366 62.1" xmlns="http://www.w3.org/2000/svg">
				...
				<ul class="list-inline position-relative justify-content-center justify-content-lg-start mb-4">
					...
					<li class="list-inline-item"> <i class="bi bi-patch-check-fill h6 me-1"></i>Get a good skill
					</li>
				</ul>
					...
					<div class="row position-relative">
						...
						<div class="col-11 mx-auto position-relative">
							<div class="row align-items-center">
								<!-- Title -->
								<div class="col-lg-7">
									<h3 class="text-white">Become a good skiller!</h3>
									<p class="text-white mb-3 mb-lg-0">
										Study can help you to be a good skiller in the copany or bank and can
										develop your country, and your life better one day to one day..</p>
								</div>
								<!-- Content and input -->
								<div class="col-lg-5 text-lg-end">
									<a href="#" class="btn btn-outline-warning mb-0">Start Learning from Today</a>
								</div>
							</div>
						</div>
					</div> <!-- Row END -->
