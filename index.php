...
if (urlIs('/signin') || urlIs('/signup') || urlIs('/signout')) {
    ...
    require "user.router.php";
} else if (urlIs('/steam-student') || (urlIs('/classwork-student')) || (urlIs('/people-student')) || (urlIs('/grade-student')) || (urlIs("/instruction-assignment")) || (urlIs("/student-work")) || (urlIs("/view-student-work"))) {
    require "user.router.php";
